...
public class VideoPlayer extends YouTubeBaseActivity implements Player.EventListener, YouTubePlayer.OnInitializedListener{
    String FilePath;
    ActivityVideoPlayerBinding binding;
    SessionManager sessionManager;
    Context context;
    SimpleExoPlayer player;
    boolean QuizPlay=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_video_player);
        ...
        if (getIntent()!=null){
            ...
            QuizPlay= getIntent().getBooleanExtra("QuizPlay", false);
        ...
        binding.ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (QuizPlay){
                    Intent intent= new Intent(VideoPlayer.this, Fundamental_Quiz_Splash.class);
