...
//
//    private Button homeBtn, paymentBtn, couponBtn, walletBtn, historyBtn, shareBtn, logoutBtn,refer , help_btn;
//
...
//        refer = (Button) view.findViewById(R.id.refer);
...
//        }  else if (v == refer) {
//            mNavMenuItems = NavMenu.REFERRAL;
//        }
//
//
//
...
//            }
//            if (mNavMenuItems.equals(NavMenu.REFERRAL)) {
//                setBtnStates(refer);
//            }
//
//        }
...
//        refer.setSelected(button == refer);
